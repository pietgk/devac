...
const config: Config = {
  ...
  neo4jDatabase: process.env.NEO4J_DATABASE || "codegraph", // Default database for CodeGraph
  storageBatchSize: parseInt(process.env.STORAGE_BATCH_SIZE || "100", 10),
  tempDir: path.resolve(
    process.cwd(),
    process.env.TEMP_DIR || "./analysis-data/temp",
  ),
  ignorePatterns: [
    "**/node_modules/**",
    "**/.git/**",
    ...
    "**/*.spec.d.ts", // Ignore test declaration files
    "**/*.test.d.ts", // Ignore test declaration files
